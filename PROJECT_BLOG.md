...
![主界面](./screenshots/main-view.png)

*完整的元素周期表展示，包含顶部粒子动画区和控制栏*
...
#### 量子蓝域 (Quantum Blue)
![量子蓝域主题](./screenshots/theme-quantum.png)

#### 恒星熔炉 (Solar Furnace)
![恒星熔炉主题](./screenshots/theme-solar.png)

#### 极光矩阵 (Aurora Matrix)
![极光矩阵主题](./screenshots/theme-aurora.png)

#### 赤焰轨道 (Ember Orbit)
![赤焰轨道主题](./screenshots/theme-ember.png)

#### 星云幻境 (Nebula Dream)
![星云幻境主题](./screenshots/theme-nebula.png)

#### 碳基终端 (Carbon Terminal)
![碳基终端主题](./screenshots/theme-carbon.png)
...
#### 粒子扰动效果
![粒子交互](./screenshots/particle-interaction.png)
...
#### 悬浮详情卡片
![悬浮卡片](./screenshots/floating-card.png)
...
#### 搜索与过滤
![搜索过滤](./screenshots/search-filter.png)
...
#### 分类筛选
![分类筛选](./screenshots/category-filter.png)
...
#### 桌面端视图
![桌面端](./screenshots/desktop-view.png)
...
> **📌 截图说明**：请将实际运行时的截图保存到 `screenshots/` 目录，并替换上述图片路径。建议使用以下尺寸：
> - 主界面：1920×1080
> - 主题切换：1280×720
> - 交互细节：800×600
> - 移动端：375×812
